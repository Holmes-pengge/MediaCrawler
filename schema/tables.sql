-- ----------------------------
-- Table structure for tb_bilibili_user
-- ----------------------------
DROP TABLE IF EXISTS `tb_bilibili_user`;
CREATE TABLE `tb_bilibili_user`
(
    ...
    `follows_count`  varchar(16)  DEFAULT NULL COMMENT '关注数',
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_bilibili_video`;
CREATE TABLE `tb_bilibili_video`
(
    `id`                  int         NOT NULL AUTO_INCREMENT COMMENT '自增ID',
    ...
    `pubdate`             bigint      NOT NULL DEFAULT 0 COMMENT '视频发布时间戳',
    `liked_count`         varchar(16)          DEFAULT NULL COMMENT '视频点赞数',
    `favorite_count`      varchar(16)          DEFAULT NULL COMMENT '视频收藏数',
    `coin_count`          varchar(16)          DEFAULT NULL COMMENT '视频投币数',
    `share_count`         varchar(16)          DEFAULT NULL COMMENT '视频转发数',
    `video_play_count`    varchar(16)          DEFAULT NULL COMMENT '视频播放数量',
    `video_danmaku_count` varchar(16)          DEFAULT NULL COMMENT '视频弹幕数量',
    `video_comment_count` varchar(16)          DEFAULT NULL COMMENT '视频评论数量',
    ...
    KEY                   `idx_bilibili_vi_create__73e0ec` (`pubdate`)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='B 站视频评论';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='抖音视频';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='抖音视频评论';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='快手视频';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='快手视频评论';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='微博帖子';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='微博帖子评论';
...
(
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='小红书博主';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='小红书笔记';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='小红书笔记评论';
